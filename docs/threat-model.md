...
| Ciphertext tampering                  | Stored encrypted data is modified                                      | Current: browser-side WASM crypto uses AES-GCM authentication tags and rejects modified encrypted payloads                                             |
