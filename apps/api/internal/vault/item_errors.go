...
var (
	...
	ErrItemEncryptedPayloadEmpty    = errors.New("encrypted item payload is empty")
	ErrItemEncryptedPayloadInvalid  = errors.New("encrypted item payload is invalid")
	ErrItemEncryptedPayloadTooLarge = errors.New("encrypted item payload is too large")
